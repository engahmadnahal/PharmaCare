...
@section('page-name',__('cms.storehouse'))
@section('main-page',__('cms.content_management'))
@section('sub-page',__('cms.storehouse'))
...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">{{__('cms.storehouse')}}</span>
            <span class="text-muted mt-3 font-weight-bold font-size-sm"></span>
        </h3>
        @can('Create-StoreHouse')
        <div class="card-toolbar">
            <a href="{{route('store_houses.create')}}"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pr-0 text-right">
                            ...
                            <a href="{{route('store_houses.edit',$c->id)}}"
...
<script>
    function performDestroy(id,reference) {
        confirmDestroy('/cms/admin/store_houses', id, reference);
    }
</script>
@endsection