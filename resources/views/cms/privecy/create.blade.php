...
@section('page-name',__('cms.privacy'))
@section('main-page',__('cms.settings'))
@section('sub-page',__('cms.privacy'))
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form id="create-form">
                <div class="card-body">
                    ...
                    <x-input name="{{__('cms.title_en')}}" type="text" id="title_en" dir="ltr"/>
                    <x-textarea name="{{__('cms.body_ar')}}" type="text" id="body_ar"/>
                    <x-textarea name="{{__('cms.body_en')}}" type="text" id="body_en" dir="ltr"/>
                    <x-image id="image"/>
...
<script>
    ...
    function performStore(){
        ...
        store('/cms/admin/privecies',formData);
