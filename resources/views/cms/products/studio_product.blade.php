                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="overlay">
                                            <div class="overlay-wrapper rounded bg-light text-center">
                                                <img src="{{Storage::url($prd->product->image)}}" alt="" class="mw-100" style=" width: 100%; height: 200px; object-fit: cover; border-radius: 11px;">
                                            </div>
                                            <div class="overlay-layer">
                                                {{-- <a href="#" class="btn font-weight-bolder btn-sm btn-primary mr-2">{{$prd->product->joomlaString}}</a> --}}
                                            </div>
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Details-->
                                        <div class="text-center mt-5 mb-md-0 mb-lg-5 mb-md-0 mb-lg-5 mb-lg-0 mb-5 d-flex flex-column">
                                            <a href="#" class="font-size-h5 font-weight-bolder text-dark-75 text-hover-primary mb-1">{{$prd->product->name}}  </a>
                                            <span class="font-size-lg">Amount In My Studio: {{$prd->amount}}</span>
                                        </div>
                                        <!--end::Details-->
                                    </div>
                                </div>
