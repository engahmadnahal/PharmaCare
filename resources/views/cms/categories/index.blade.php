            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th style="min-width: 150px">{{__('cms.sub_categories')}}</th>
                    ...
                    <tr>
                        <td class="pl-0">
                            <a href="{{route('categories.show',$category->id)}}"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$category->translations->first()?->name
                                ?? ''}}</a>
                        </td>
                        <td>
                            <span href="#" class="label label-lg label-light-success label-inline">{{$category->code
                                ?? ''}}</span>
                        </td>
                        <td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pr-0 text-right">
                                                            @can('Update-City')
                                                            <a href="{{route('category-translations.edit',$translation->id)}}"
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                        ...
                                        <a class="dropdown-item" href="#">{{__('cms.count_is')}}:
                                            <strong> {{$category->sub_categories_count}}</strong></a>
                                    </div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="pr-0 text-right">
                            @can('Create-City')
                            <a href="{{route('category-translations.create',$category->id)}}"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm">
                            ...
                            @endcan
                            @can('Delete-City')
                            <a href="#" onclick="performCategoryDestroy('{{$category->id}}', this)"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/Trash.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
