    ...
    <div class="col-xl-3">
        ...
        <a href="#" class="card card-custom bg-danger bg-hover-state-danger card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <div class="text-inverse-danger font-weight-bolder font-size-h6 mb-2 mt-5">{{__('cms.pharm_num')}}
                    ({{$studios}})
                </div>
    ...
    <div class="col-xl-3">
        ...
        <a href="#" class="card card-custom bg-success bg-hover-state-success card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <div class="text-inverse-danger font-weight-bolder font-size-h6 mb-2 mt-5">{{__('cms.contact_us_message')}}
                    ({{$contactUs}})
                </div>
    ...
    <div class="col-xl-3">
        ...
        <a href="#" class="card card-custom bg-danger bg-hover-state-danger card-stretch gutter-b">
            ...
            <div class="card-body">
                ...
                <div class="text-inverse-danger font-weight-bolder font-size-h6 mb-2 mt-5">{{__('cms.doctor')}}
                    ({{$branches}})
                </div>
...
<div class="row">
    ...
    <div class="card-header border-0 py-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">{{__('cms.last_pharm_register')}}</span>
        </h3>
