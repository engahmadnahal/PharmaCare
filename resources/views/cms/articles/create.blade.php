...
@section('page-name-small','Create Article')
            ...
            <form id="create-form">
                <div class="card-body">
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="title_ar" placeholder="Enter arabic title" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <textarea class="form-control" id="content_ar" maxlength="1000" rows="3"
                                placeholder="Enter arabic content"></textarea>
