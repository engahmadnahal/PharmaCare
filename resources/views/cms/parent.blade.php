...
<head>
    ...
    <style>
        .pulse.pulse-primary .pulse-ring {
            border-color: rgb(255 54 134 / 75%);
        }
...
<body id="kt_body"
    ...
    <div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10 ">
            ...
            <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-primary flex-grow-1 px-10"
                ...
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab"
                        href="#kt_quick_panel_notifications">{{ __('cms.notifications') }}</a>
                </li>
        ...
        <div class="offcanvas-content px-10">
            <div class="tab-content">
                <!--begin::Tabpane-->
                <div class="tab-pane fade pt-2 pr-5 mr-n5 scroll ps active show ps--active-y"
                        ...
                        <div class="topbar">
                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon btn-clean btn-lg mr-1 pulse pulse-primary"
                                    id="kt_quick_panel_toggle" onclick="markRead()">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label"
                        style="background-image:url('{{ Storage::url(auth()->user()->avater) }}')"></div>
    ...
    <script>
        ...
        function markRead() {
            axios.post('/cms/admin/notification/read', {}).then((response) => {}).catch((error) => {});
        }
    </script>
    @yield('scripts')
</body>
