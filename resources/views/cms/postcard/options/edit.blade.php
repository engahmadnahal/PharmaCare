            ...
            <form id="create-form">
                <div class="card-body">
                    <div class="form-group row mt-4">
                        <label class="col-3 col-form-label">{{__('cms.postcard_services')}}:<span
                                class="text-danger">*</span></label>
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="postcard_id"
                                    title="Choose one of the following..." tabindex="null" data-live-search="true">
                                    @foreach ($postcards as $s)
                                    <option value="{{$s->id}}" @selected($s->id == $data->postcard_service_id)>{{$s->title}}</option>
                                    @endforeach
                                </select>
                            </div>
...
<script>
    ...
    function performEdit(id){
        ...
        formData.append('postcard_id',document.getElementById('postcard_id').value);
        ...
        store('/cms/admin/option_postcard_services/'+id, formData, '/cms/admin/option_postcard_services');
    }
</script>
@endsection