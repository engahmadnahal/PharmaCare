...
@section('page-name', __('cms.financial_cash'))
@section('main-page', __('cms.reports'))
@section('sub-page', __('cms.financial_cash'))
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">{{ __('cms.financial_cash') }}</span>
    ...
    <script>
        function performFilter() {
            let from = $('#from').val(),
                ...
                `{{ route('reports.financial.cash') }}?from=${from}&to=${to}`;
        }
    </script>
@endsection
