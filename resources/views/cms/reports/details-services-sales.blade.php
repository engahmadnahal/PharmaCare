...
@section('page-name', __('cms.service_sales'))
@section('main-page', __('cms.reports'))
@section('sub-page', __('cms.service_sales'))
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">{{ __('cms.service_sales') }}</span>
            ...
            <div class="card-toolbar">
                ...
                <div class="actions" style="width: 100%;display: flex;justify-content: end;">
                    ...
                    <a href="{{ route('reports.details.sales.excel') }}"
        ...
        <script>
            function performFilter() {
                let from = $('#from').val(),
                    ...
                    `{{ route('reports.details.sales') }}?from=${from}&to=${to}`;
            }
        </script>
    @endsection
