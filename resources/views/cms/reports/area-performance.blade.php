...
@section('page-name', __('cms.area_performance'))
@section('main-page', __('cms.reports'))
@section('sub-page', __('cms.area_performance'))
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">{{ __('cms.area_performance') }}</span>
                    ...
                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                        <thead>
                            <tr class="text-uppercase">
                                <th style="max-width: 150px">{{ __('cms.city') }}</th>
        ...
        <script>
            function performFilter() {
                let from = $('#from').val(),
                    ...
                    `{{ route('reports.area.performance') }}?from=${from}&to=${to}`;
            }
        </script>
    @endsection
