...
@section('page-name', __('cms.performance'))
@section('main-page', __('cms.reports'))
@section('sub-page', __('cms.performance'))
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">{{ __('cms.performance') }}</span>
            ...
            <div class="card-toolbar">
                ...
                <div class="actions" style="width: 100%;display: flex;justify-content: end;">
                    ...
                    <a href="{{ route('reports.performance.excel') }}"
        ...
        <script>
            function performFilter() {
                let from = $('#from').val(),
                    ...
                    `{{ route('reports.performance') }}?from=${from}&to=${to}`;
            }
        </script>
    @endsection
