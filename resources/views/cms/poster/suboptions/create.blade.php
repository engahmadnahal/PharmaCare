            ...
            <form id="create-form">
                <div class="card-body">
                    <div class="form-group row mt-4">
                        <label class="col-3 col-form-label">{{__('cms.package')}}:<span
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="type"
                                    title="Choose one of the following..." tabindex="null" data-live-search="true">
                                        <option value="print">{{__('cms.print_section')}}</option>
                                        <option value="frame">{{__('cms.frame_section')}}</option>
                                        <option value="printColor">{{__('cms.printColor_section')}}</option>
                                </select>
                            </div>
                            <span class="form-text text-muted">{{__('cms.please_select')}}
                                {{__('cms.type')}}</span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <span class="switch switch-outline switch-icon switch-success">
                                <label>
                                    <input type="checkbox" checked="checked" id="isPrice">
                                    <span></span>
                                </label>
                            </span>
                        </div>
...
<script>
    ...
    function performStore(){
        ...
        store('/cms/admin/sub_option_posterprint_services',formData);
    }
</script>
@endsection