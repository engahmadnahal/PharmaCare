                            ...
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="option_posterprint_service_id"
                                    ...
                                    @foreach ($optionPoster as $s)
                                        <option value="{{$s->id}}" @selected($s->id == $data->option_posterprint_service_id)>{{$s->title}}</option>
                                    @endforeach
                                </select>
                            </div>
...
<script>
    ...
    function performEdit(id){
        ...
        store('/cms/admin/packge_poster_services/'+id, formData, '/cms/admin/packge_poster_services');
    }
</script>
@endsection