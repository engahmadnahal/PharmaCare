            ...
            <form id="create-form">
                <div class="card-body">
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="title_en" placeholder="{{__('cms.title_en')}}" dir="ltr" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="number" class="form-control" id="height" placeholder="{{__('cms.height')}}" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="number" class="form-control" id="width" placeholder="{{__('cms.width')}}" />
...
<script>
    ...
    function performStore(){
        ...
        store('/cms/admin/option_posterprint_services',formData);
    }
</script>
@endsection