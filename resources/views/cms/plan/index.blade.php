    ...
    <div class="card-header border-0 py-5">
        ...
        <div class="card-toolbar">
            <a href="{{route('plans.create')}}"
                class="btn btn-info font-weight-bolder font-size-sm">{{__('cms.new_plan')}}</a>
        </div>
        @endcan
    </div>
    <!--end::Header-->
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        @canany(['Update-Plan','Delete-Plan'])
                ...
                <tbody>
                    ...
                    <tr>
                        {{-- <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$plan->id}}</a>
                        </td> --}}
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$plan->name ??
                                ''}}</a>
                        </td>

                        <td>
                            <a href="#" data-toggle="modal" data-target="#plan_{{$plan->id}}_translations"
                                class="btn btn-light-primary font-weight-bolder font-size-sm">({{$plan->translations_count}})</a>
                            <div class="modal fade" id="plan_{{$plan->id}}_translations" tabindex="-1" role="dialog"
                                aria-labelledby="plan_{{$plan->id}}_translations" aria-hidden="true">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pr-0 text-right">
                                                            @can('Update-Plan')
                                                            <a href="{{route('plans-translations.edit',$translation->id)}}"
                        ...
                        <td class="pr-0 text-right">
                            @can('Create-Plan')
                            <a href="{{route('plans-translations.create',$plan->id)}}"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm">
                            ...
                            @endcan
                            @can('Delete-Plan')
                            <a href="#" onclick="performcityDestroy('{{$plan->id}}', this)"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/Trash.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
