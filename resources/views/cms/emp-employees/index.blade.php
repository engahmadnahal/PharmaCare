            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th style="min-width: 100px">{{__('cms.avater')}}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="pl-0">
                            <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$employee->name}}</a>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$employee->mobile}}</span>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$employee->email}}</span>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$employee->national_id}}</span>
                        </td>
                        <td>
                            <span class="label label-lg label-light-success label-inline">{{$employee->pharmaceutical?->name}}</span>
                        </td>
                        <td>
                            <span class="label label-lg {{$employee->active ? 'label-light-success' : 'label-light-danger'}} label-inline">
                                {{$employee->active ? __('cms.active') : __('cms.inactive')}}
                            </span>
                        </td>
                        <td>
                            @if($employee->avater)
                            <img src="{{asset('storage/' . $employee->avater)}}" alt="Avatar" style="width: 50px; height: 50px; border-radius: 50%;">
                            @else
                        ...
                        <td class="pr-0 text-right">
                            ...
                            <a href="#" onclick="performDestroy('{{$employee->id}}', this)" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
