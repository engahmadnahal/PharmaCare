        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form id="create-form">
                <div class="card-body">
                    ...
                    <x-input type="text"  name="{{__('cms.title_en')}}" id="title_en" />

                    
                    <x-input type="text" name="{{__('cms.note_ar')}}" id="note_ar" />
                    <x-input type="text"  name="{{__('cms.note_en')}}" id="note_en" />
                    
                    <x-textarea name="{{__('cms.description_ar')}}" id="description_ar" />
                    <x-textarea name="{{__('cms.description_en')}}" id="description_en" />
...
<script>
    ...
    function performStore(){
        ...
        store('/cms/admin/frames_or_albums',formData);
    }
</script>
@endsection