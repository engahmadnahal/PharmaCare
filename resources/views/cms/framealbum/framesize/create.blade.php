            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <form id="create-form">
                    <div class="card-body">
                        ...
                        <x-input type="number" name="{{ __('cms.width') }}" id="width" />
                        <x-input type="number" name="{{ __('cms.height') }}" id="height" />
...
@section('scripts')
    <script>
        ...
        function performStore() {
            ...
            //         {
            //             currncyId: {{ $crr->id }},
            //             value: document.getElementById('price_qs_{{ $crr->id }}').value,
            //         },
            //     @endforeach
            ...
            store('/cms/admin/frames_sizes', formData);
        }
    </script>
@endsection
