        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form id="create-form">
                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="type"
                                    title="Choose one of the following..." tabindex="null" data-live-search="true">
                                        <option value="yesOrNo" @selected($data->type == 'yesOrNo')>{{__('cms.yesOrNo')}}</option>
                                </select>
                            </div>
                            <span class="form-text text-muted">{{__('cms.please_select')}}
                                {{__('cms.type')}}</span>
                    ...
                    <x-input type="text" name="{{__('cms.qs_ar')}}" id="qs_ar" value="{{$data->qs_ar}}"/>
                    <x-input type="text"  name="{{__('cms.qs_en')}}" id="qs_en" value="{{$data->qs_en}}" dir="ltr"/>
...
<script>
    ...
    function performEdit(id){
        ...
        update('/cms/admin/qs_frames_albums/'+id, data, '/cms/admin/qs_frames_albums');
    }
</script>
@endsection