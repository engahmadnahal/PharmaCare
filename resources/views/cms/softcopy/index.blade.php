...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        ...
        <div class="card-toolbar">
            <a href="{{route('soft_copy_services.create')}}"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pr-0 text-right">
                            @can('Update-SoftCopyService')
                            <a href="{{route('soft_copy_services.edit',$std->id)}}"
...
<script>
    function performDestroy(id,reference) {
        confirmDestroy('/cms/admin/soft_copy_services', id, reference);
    }
</script>
@endsection