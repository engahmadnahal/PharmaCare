            ...
            <div class="card card-flush py-4 flex-row-fluid">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <h2>Frame & Album (Total : {{$data->total}} {{$data->currencyCode}})</h2>
                    </div>
                </div>
                <!--end::Card header-->
                <!--begin::Card body-->
                        ...
                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bolder text-end">{{$data?->type == 'frame' ? 'Frame' : 'album'}} </td>
                                </tr>
                                <!--end::Date-->
                                <tr>
                                    <td class="text-muted">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--end::Svg Icon-->
                                            Frame Choice or Album Choice
                                        </div>
                                    </td>
                                    <td class="fw-bolder text-end">{{$data?->frameOrAlbum->title}}</td>
                                </tr>
