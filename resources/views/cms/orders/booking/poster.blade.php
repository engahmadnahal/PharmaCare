            ...
            <div class="card card-flush py-4 flex-row-fluid">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <h2>Poster (Total : {{$data->total}} {{$data->currencyCode}})</h2>
                    </div>
                </div>
                <!--end::Card header-->
                <!--begin::Card body-->
                        ...
                        <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bolder text-end">{{ $data->sizeTitle ?? '-'}}</td>
                                </tr>
                                <!--end::Date-->
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bolder text-end">{{$data?->package->title?? '-'}}</td>
                                </tr>
                                <!--end::Payment method-->
                                <!--begin::Date-->
                                <tr>
                                    ...
                                    <td class="fw-bolder text-end">{{ $data?->copies ?? '-'}}</td>
                                </tr>
                                <!--end::Date-->
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bolder text-end">{{ $data?->photo_num ?? '-'}}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bolder text-end">{{$data?->printType->title ?? '-'}}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bolder text-end">{{$data?->frameType->title ?? '-'}}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bolder text-end">{{$data?->printColor->title ?? '-'}}</td>
                                </tr>
