                ...
                <form id="create-form">
                    <div class="card-body">
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control" id="title_en" dir="ltr"
                                    placeholder="{{ __('cms.title_en') }}" />
                                <span class="form-text text-muted">{{ __('cms.please_enter') }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <span class="switch switch-outline switch-icon switch-success">
                                    <label>
                                        <input type="checkbox" c id="isNote">
                                        <span></span>
                                    </label>
                                </span>
                            </div>
...
@section('scripts')
    <script>
        ...
        function performStore() {
            ...
            store('/cms/admin/passport_services', formData);
        }
    </script>
@endsection
