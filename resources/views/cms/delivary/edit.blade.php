            ...
            <form id="create-form">
                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="region_id"
                                    ...
                                    <option value="{{$r->id}}" @selected($r->id == $delivary->region_id)>{{$r->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="name" value="{{$delivary->name}}"
                                placeholder="Enter full name"  value="{{$delivary->name}}"/>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="number" class="form-control" id="mobile"
                                placeholder="{{__('cms.mobile')}}" value="{{$delivary->mobile}}" />
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="address"
                                placeholder="{{__('cms.address')}}" value="{{$delivary->address}}"/>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="number" class="form-control" id="national_id"
                                placeholder="{{__('cms.national_id')}}" value="{{$delivary->national_id}}"/>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-9">
                            <div class="image-input image-input-empty image-input-outline" id="kt_image_6"
                                style="background-image: url({{ Storage::url($delivary->avater) }})">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <span class="switch switch-outline switch-icon switch-success">
                                <label>
                                    <input type="checkbox" @checked($delivary->active)
                                    id="active">
                                    <span></span>
                                </label>
                            </span>
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <button type="button" onclick="performEdit('{{$delivary->id}}')"
...
<script>
    ...
    function performEdit(id){
        ...
        store('/cms/admin/delivaries/'+id, formData, '/cms/admin/delivaries');
    }
</script>
@endsection