        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form id="create-form">
                <div class="card-body">
                    ...
                    <x-textarea name="{{__('cms.description_ar')}}" type="description_ar" id="about_ar"/>
                    <x-textarea name="{{__('cms.description_en')}}" type="description_en" id="about_en"/>
...
<script>
    ...
    function performStore(){
        ...
        store('/cms/admin/booking_studio_services',formData);
    }
</script>
@endsection