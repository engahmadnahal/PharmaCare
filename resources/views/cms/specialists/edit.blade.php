            ...
            <form>
                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="role_id"
                                    ...
                                    <option value="{{$role->id}}" value="{{$role->id}}" @if (!is_null($assignedRole) &&
                                        $assignedRole->id ==
                                        $role->id) selected
                            ...
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="city_id"
                                    ...
                                    <option value="{{$city->id}}" @if($city->id ==
                                        $specialist->city_id) selected @endif>{{$city->name_en}}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="full_name" value="{{$specialist->full_name}}"
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="user_name" value="{{$specialist->user_name}}"
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="gender"
                                    title="{{__('cms.select_hint')}}" tabindex="null" data-live-search="true">
                                    <option value="M" @if($specialist->gender == 'M') selected @endif>Male</option>
                                    <option value="F" @if($specialist->gender == 'F') selected @endif>Female</option>
                                </select>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <input type="text" class="form-control" readonly="readonly" id="birth_date"
                                placeholder="{{__('cms.birth_date')}}" value="{{$specialist->birth_date}}">
                    ...
                    <div class="form-group row">
                        <label class="col-3 col-form-label">{{__('cms.id_card')}}:<span
                                class="text-danger">*</span></label>
                        <div class="col-9">
                            <input type="number" class="form-control" id="id_card" placeholder="{{__('cms.id_card')}}"
                                value="{{$specialist->id_card}}" />
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="qualification"
                                    title="{{__('cms.select_hint')}}" tabindex="null" data-live-search="true">
                                    <option value="diploma" @if($specialist->qualification == 'diploma') selected
                                        @endif>Diploma</option>
                                    <option value="bachelor" @if($specialist->qualification == 'bachelor') selected
                                        @endif>Bachelor</option>
                                    <option value="master" @if($specialist->qualification == 'master') selected
                                        @endif>Master</option>
                                    <option value="doctor" @if($specialist->qualification == 'doctor') selected
                                        @endif>Doctor</option>
                                </select>
                            </div>
                            <span class="form-text text-muted">{{__('cms.please_select')}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <input type="number" class="form-control" id="experience_years"
                                ...
                                value="{{$specialist->experience_years}}" />
                            <span class="form-text text-muted">{{__('cms.please_enter')}}
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-9">
                            <textarea class="form-control" id="practical_bio" maxlength="150" rows="3"
                                placeholder="{{__('cms.practical_bio')}}">{{$specialist->practical_bio}}</textarea>
                            <span class="form-text text-muted">{{__('cms.please_enter')}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <span class="switch switch-outline switch-icon switch-success">
                                <label>
                                    <input type="checkbox" @if($specialist->active) checked="checked" @endif
                                    id="status">
                                    <span></span>
                                </label>
                            </span>
...
<script>
    function performEdit(){
        ...
        update('/cms/admin/specialists/{{$specialist->id}}', data, '/cms/admin/specialists');
    }
</script>
@endsection