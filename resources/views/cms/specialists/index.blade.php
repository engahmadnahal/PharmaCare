        ...
        <div class="d-flex">
            ...
            <div class="flex-shrink-0 mr-7">
                <div class="symbol symbol-50 symbol-lg-120">
                    <img alt="Pic" src="{{url('assets/media//users/300_1.jpg')}}" />
                </div>
            </div>
            <!--end::Pic-->
            <!--begin: Info-->
            <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                    ...
                    <div class="mr-3">
                        <!--begin::Name-->
                        <a href="#"
                            class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">{{$specialist->name}}
                        ...
                        <div class="d-flex flex-wrap my-2">
                            ...
                            <a href="#"
                                ...
                                <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                    ...
                                    <!--end::Svg Icon-->
                                </span>{{$specialist->qualification}}</a>
                    ...
                    <div class="my-lg-0 my-1">
                        ...
                        <a href="{{route('specialists.edit',$specialist->id)}}" class="btn btn-sm btn-light-primary"><i
                                class="flaticon-edit"></i>Edit</a>
                        <a href="#" onclick="performDestroy('{{$specialist->id}}', this)"
                            class="btn btn-sm btn-light-danger"><i class="flaticon-delete"></i>Delete</a>
                    </div>
                    <!--end::Actions-->
                </div>
                <!--end::Title-->
        ...
        <div class="d-flex align-items-center flex-wrap">
            <div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
                ...
                <div class="d-flex flex-column flex-lg-fill">
                    <span class="text-dark-75 font-weight-bolder font-size-sm">{{$specialist->_services_count}}
                        Service/s</span>
                    <a href="{{route('specialists.show',$specialist->id)}}"
                        class="text-primary font-weight-bolder">Assign</a>
                </div>
            </div>
            <!--begin: Item-->
            <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                ...
                <div class="d-flex flex-column flex-lg-fill">
                    <span class="text-dark-75 font-weight-bolder font-size-sm">{{$specialist->reservations_count}} Reservations</span>
...
<script>
    function performDestroy(id,reference) {
        confirmDestroy('/cms/admin/specialists', id, reference);
    }
</script>
@endsection