...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator($request->all(), [
            ...
            'drug_description_ar' => 'required|string|max:255',
            'drug_description_en' => 'required|string|max:255',
            'indications_for_use_ar' => 'required|string|max:255',
            'indications_for_use_en' => 'required|string|max:255',
            'recommended_dosage_ar' => 'required|string|max:255',
            'recommended_dosage_en' => 'required|string|max:255',
            'how_to_use_ar' => 'required|string|max:255',
            'how_to_use_en' => 'required|string|max:255',
            'drug_interactions_ar' => 'required|string|max:255',
            'drug_interactions_en' => 'required|string|max:255',
            'side_effects_ar' => 'required|string|max:255',
            'side_effects_en' => 'required|string|max:255',
            'alternative_medicines_ar' => 'required|string|max:255',
            'alternative_medicines_en' => 'required|string|max:255',
            'complementary_medicines_ar' => 'required|string|max:255',
            'complementary_medicines_en' => 'required|string|max:255',
